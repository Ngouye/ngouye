    ...
    <section id="certifications" className="py-24 px-6 relative bg-gradient-to-b from-transparent via-gray-900/50 to-transparent">
        <div className="max-w-7xl mx-auto">
            <SectionTitle 
                ...
                subtitle="Mes certifications académiques et professionnelles" 
            />
            ...
            <div className="grid md:grid-cols-1 gap-8 max-w-4xl mx-auto">
                {portfolioData.certifications.map((certification, index) => (
                    <div 
                        key={index} 
                        className="group bg-gradient-to-br from-gray-800 to-gray-900 p-8 rounded-3xl border border-gray-700 hover:border-cyan-500 transition-all duration-300 transform hover:-translate-y-1"
                    >
                            ...
                            {certification.image ? (
                                ...
                                <div className="text-center py-8">
                                    <div className="bg-gradient-to-br from-gray-700 to-gray-800 rounded-2xl p-8 border border-cyan-500/30">
                                        ...
                                        <p className="text-gray-400 mb-4">
                                            Image du certificat non disponible
                                        </p>
